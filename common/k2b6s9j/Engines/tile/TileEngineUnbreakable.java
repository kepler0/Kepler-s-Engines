...
import k2b6s9j.Engines.engines.EngineBedrock;
import k2b6s9j.Engines.engines.EngineUnbreakable;
import k2b6s9j.Engines.engines.EngineUnknownUnbreakable;
...
public class TileEngineUnbreakable extends TileKeplersEngines implements IPowerReceptor, IInventory, ITankContainer, IOverrideDefaultTriggers,
		IPipeConnection, IBuilderInventory {

	public @TileNetworkData
	EngineUnbreakable engine;
	public @TileNetworkData
	int progressPart = 0;
	public @TileNetworkData
	...
	public void initialize() {
		if (!Proxy.proxy.isRenderWorld(worldObj)) {
			if (engine == null) {
	...
	public EngineUnbreakable newEngine(int meta) {
		if (meta == 0)
			return new EngineBedrock(this);
		else
			return new EngineUnknownUnbreakable(this);
	}
	...
	*/
	...
	public boolean isPipeConnected(ForgeDirection with) {
		if (engine instanceof EngineBedrock)
			return false;
